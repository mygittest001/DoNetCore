#pragma checksum "D:\project\2019\网易云课堂\GitPro\NewsPublish.Web\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9a60c8f179a54ec723b0b0f0df243decc00a4b37"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9a60c8f179a54ec723b0b0f0df243decc00a4b37", @"/Views/Home/Index.cshtml")]
...
<aside class=""sidebar"">
    <div class=""fixed"">
        ...
        <div class=""widget widget_search"">
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "cbb7209fc35a4bcba2441839bbd0c7e0", async() => {
            ...
            success: function (data) {
                if (data.code == 200) {
                    ...
                    for (var i = 0; i < data.data.length; i++) {
                        var m = data.data[i];
                        var news;
                        news = '<li><a title = ""' + m.title + '"" href = ""/News/Detail?id=' + m.id + '"" ><span class=""thumbnai");
            WriteLiteral(@"l""><img class=""thumb"" data-original=""' + m.image + '"" src=""' + m.image + '"" alt=""' + m.title + '"" style=""display: block;""></span><span class=""text"">' + m.title + '</span><span class=""muted""><i class=""glyphicon glyphicon-time""></i>' + m.publishDate + '</a></li>';
